...
\f\r]`,C=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,te=/-->/g,se=/>/g,A=RegExp(`>|${z}(?:([^\\s"'>=/]+)(${z}*=${z}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ie=/'/g,ne=/"/g,de=/^(?:script|style|textarea|title)$/i,Ue=n=>(e,...t)=>({_$litType$:n,strings:e,values:t}),f=Ue(1),S=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),re=new WeakMap,b=v.createTreeWalker(v,129);function pe(n,e){if(!q(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return ee!==void 0?ee.createHTML(e):e}const Oe=(n,e)=>{const t=n.length-1,s=[];let i,r=e===2?"<svg>":e===3?"<math>":"",o=C;for(let c=0;c<t;c++){const l=n[c];let d,u,a=-1,_=0;for(;_<l.length&&(o.lastIndex=_,u=o.exec(l),u!==null);)_=o.lastIndex,o===C?u[1]==="!--"?o=te:u[1]!==void 0?o=se:u[2]!==void 0?(de.test(u[2])&&(i=RegExp("</"+u[2],"g")),o=A):u[3]!==void 0&&(o=A):o===A?u[0]===">"?(o=i??C,a=-1):u[1]===void 0?a=-2:(a=o.lastIndex-u[2].length,d=u[1],o=u[3]===void 0?A:u[3]==='"'?ne:ie):o===ne||o===ie?o=A:o===te||o===se?o=C:(o=A,i=void 0);const $=o===A&&n[c+1].startsWith("/>")?" ":"";r+=o===C?l+ke:a>=0?(s.push(d),l.slice(0,a)+ce+l.slice(a)+y+$):l+y+(a===-2?c:$)}return[pe(n,r+(n[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class U{constructor({strings:e,_$litType$:t},s){let i;this.parts=[];let r=0,o=0;const c=e.length-1,l=this.parts,[d,u]=Oe(e,t);if(this.el=U.createElement(d,s),b.currentNode=this.el.content,t===2||t===3){const a=this.el.content.firstChild;a.replaceWith(...a.childNodes)}for(;(i=b.nextNode())!==null&&l.length<c;){if(i.nodeType===1){if(i.hasAttributes())for(const a of i.getAttributeNames())if(a.endsWith(ce)){const _=u[o++],$=i.getAttribute(a).split(y),L=/([.?@])?(.*)/.exec(_);l.push({type:1,index:r,name:L[2],strings:$,ctor:L[1]==="."?Re:L[1]==="?"?Ie:L[1]==="@"?Me:H}),i.removeAttribute(a)}else a.startsWith(y)&&(l.push({type:6,index:r}),i.removeAttribute(a));if(de.test(i.tagName)){const a=i.textContent.split(y),_=a.length-1;if(_>0){i.textContent=I?I.emptyScript:"";for(let $=0;$<_;$++)i.append(a[$],k()),b.nextNode(),l.push({type:2,index:++r});i.append(a[_],k())}}}else if(i.nodeType===8)if(i.data===he)l.push({type:2,index:r});else{let a=-1;for(;(a=i.data.indexOf(y,a+1))!==-1;)l.push({type:7,index:r}),a+=y.length-1}r++}}static createElement(e,t){const s=v.createElement("template");return s.innerHTML=e,s}}function x(n,e,t=n,s){var o,c;if(e===S)return e;let i=s!==void 0?(o=t._$Co)==null?void 0:o[s]:t._$Cl;const r=N(e)?void 0:e._$litDirective$;return(i==null?void 0:i.constructor)!==r&&((c=i==null?void 0:i._$AO)==null||c.call(i,!1),r===void 0?i=void 0:(i=new r(n),i._$AT(n,t,s)),s!==void 0?(t._$Co??(t._$Co=[]))[s]=i:t._$Cl=i),i!==void 0&&(e=x(n,i._$AS(n,e.values),i,s)),e}class Le{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:s}=this._$AD,i=((e==null?void 0:e.creationScope)??v).importNode(t,!0);b.currentNode=i;let r=b.nextNode(),o=0,c=0,l=s[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new O(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new He(r,this,e)),this._$AV.push(d),l=s[++c]}o!==(l==null?void 0:l.index)&&(r=b.nextNode(),o++)}return b.currentNode=v,i}p(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}}class O{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,t,s,i){this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=i,this._$Cv=(i==null?void 0:i.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=x(this,e,t),N(e)?e===p||e==null||e===""?(this._$AH!==p&&this._$AR(),this._$AH=p):e!==this._$AH&&e!==S&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ne(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==p&&N(this._$AH)?this._$AA.nextSibling.data=e:this.T(v.createTextNode(e)),this._$AH=e}$(e){var r;const{values:t,_$litType$:s}=e,i=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=U.createElement(pe(s.h,s.h[0]),this.options)),s);if(((r=this._$AH)==null?void 0:r._$AD)===i)this._$AH.p(t);else{const o=new Le(i,this),c=o.u(this.options);o.p(t),this.T(c),this._$AH=o}}_$AC(e){let t=re.get(e.strings);return t===void 0&&re.set(e.strings,t=new U(e)),t}k(e){q(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,i=0;for(const r of e)i===t.length?t.push(s=new O(this.O(k()),this.O(k()),this,this.options)):s=t[i],s._$AI(r),i++;i<t.length&&(this._$AR(s&&s._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,t);e&&e!==this._$AB;){const i=e.nextSibling;e.remove(),e=i}}setConnected(e){var t;this._$AM===void 0&&(this._$Cv=e,(t=this._$AP)==null||t.call(this,e))}}class H{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,s,i,r){this.type=1,this._$AH=p,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=p}_$AI(e,t=this,s,i){const r=this.strings;let o=!1;if(r===void 0)e=x(this,e,t,0),o=!N(e)||e!==this._$AH&&e!==S,o&&(this._$AH=e);else{const c=e;let l,d;for(e=r[0],l=0;l<r.length-1;l++)d=x(this,c[s+l],t,l),d===S&&(d=this._$AH[l]),o||(o=!N(d)||d!==this._$AH[l]),d===p?e=p:e!==p&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!i&&this.j(e)}j(e){e===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Re extends H{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===p?void 0:e}}class Ie extends H{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==p)}}class Me extends H{constructor(e,t,s,i,r){super(e,t,s,i,r),this.type=5}_$AI(e,t=this){if((e=x(this,e,t,0)??p)===S)return;const s=this._$AH,i=e===p&&s!==p||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,r=e!==p&&(s===p||i);i&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t;typeof this._$AH=="function"?this._$AH.call(((t=this.options)==null?void 0:t.host)??this.element,e):this._$AH.handleEvent(e)}}class He{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){x(this,e)}}const B=T.litHtmlPolyfillSupport;B==null||B(U,O),(T.litHtmlVersions??(T.litHtmlVersions=[])).push("3.2.1");const De=(n,e,t)=>{const s=(t==null?void 0:t.renderBefore)??e;let i=s._$litPart$;if(i===void 0){const r=(t==null?void 0:t.renderBefore)??null;s._$litPart$=i=new O(e.insertBefore(k(),r),r,void 0,t??{})}return i._$AI(n),i};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class m extends E{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t;const e=super.createRenderRoot();return(t=this.renderOptions).renderBefore??(t.renderBefore=e.firstChild),e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=De(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return S}}var oe;m._$litElement$=!0,m.finalized=!0,(oe=globalThis.litElementHydrateSupport)==null||oe.call(globalThis,{LitElement:m});const j=globalThis.litElementPolyfillSupport;j==null||j({LitElement:m});(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push("4.1.1");class ze extends m{static get properties(){return{user:{type:String},difficulty:{type:Number},_hasIncrementScore:{type:Boolean,state:!0}}}constructor(){super(),this.difficulty=1,this._hasIncrementScore=!1}updated(e){super.updated(e),e.has("difficulty")&&this._changeDifficulty(),e.has("_hasIncrementScore")&&this._hasIncrementScore&&(this._hasIncrementScore=!1)}_changeDifficulty(){}handleLogin(e){this.user=e.detail}handleIncrement(){this._hasIncrementScore=!0}handleDifficultyChanged(e){this.difficulty=e.detail}}const Be=w`
  :host {
    display: flex;
...
`;class me extends Je{render(){return f` <div class="score">${this._points}</div>`}}h(me,"styles",[Ke]);window.customElements.define("score-panel",me);class Ze extends m{constructor(){super();h(this,"handleLogin",()=>this.dispatchEvent(new CustomEvent("login-panel:login",{detail:this.user})))}static get properties(){return{user:{type:String}}}updated(t){super.updated(t)}handleInput(t){this.user=t.target.value}}const Qe=w`
  :host {
    display: flex;
    flex-direction: column;
    align-items: center;
...
`;class _e extends Ze{render(){return f` <label class="label" for="name">Escribe tu usario</label>
      ...
      />
      <button class="styled-button" @click=${this.handleLogin}>Jugar</button>`}}h(_e,"styles",[Qe]);window.customElements.define("login-panel",_e);class Y extends m{static get properties(){return{difficulty:{type:Number}}}constructor(){super(),this.difficulty=1}handleChangeDifficulty(e){return this.difficulty=e,this.dispatchEvent(new CustomEvent("difficulty-panel:changed",{detail:this.difficulty}))}}h(Y,"DIFFICULTY_LEVELS",Object.freeze(["Fácil","Media","Difícil","Experto"]));const Xe=w`
  :host {
  }
...
`;class $e extends Y{constructor(){super(...arguments);h(this,"_renderButton",(t,s)=>f`
    ...
    ></difficulty-panel>
  `)}render(){return f` ${J(this.user,this._renderGamePanel,this._renderLoginPanel)}`}}h(ye,"styles",[Be]);window.customElements.define("touch-the-mole",ye);
